...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientId'] = 454;
        $headers['auth']['clientCompany'] = "MHbux3gcjXAbyRwvmuXG";
        $headers['auth']['clientSecret'] = "NDU0TUhidXgzZ2NqWEFieVJ3dm11WEdjZTY2ZjZlNmY5ZGVmNTEwYWM0MGJhMmU2NWMyYWNkYTAxNDJmZmFl";
